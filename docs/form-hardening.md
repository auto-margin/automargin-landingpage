...
This project applies layered anti-abuse checks for contact, login, and signup submissions.
...
- Login form: rate-limited + honeypot + minimum human submit time
- Signup form: rate-limited + honeypot + minimum human submit time

## Current limits

- Contact: `5 / 10m` and burst `2 / 30s`
- Login: `10 / 10m` and burst `2 / 30s`
- Signup: `5 / 10m` and burst `2 / 30s`

## Validation checklist

1. Normal submit works for contact/login/signup
