  ...
  return (
    ...
    >
      <div className="flex size-full max-w-lg flex-row items-stretch justify-between gap-10">
        ...
        <div className="flex flex-col justify-center">
          <Circle ref={div6Ref} className="size-20 overflow-hidden p-0">
            <Image
        ...
        <div className="flex flex-col justify-center gap-2">
          <Circle ref={div1Ref} className="size-28 overflow-hidden p-2">
            <MarketIcons.autoscout />
          </Circle>
          <Circle ref={div2Ref} className="size-28 overflow-hidden p-2">
            <MarketIcons.mobilede />
          </Circle>
          <Circle ref={div3Ref} className="size-28 overflow-hidden p-2">
            <MarketIcons.cochenet />
          </Circle>
          <Circle ref={div4Ref} className="size-28 overflow-hidden p-2">
            <MarketIcons.lacentrale />
          </Circle>
          <Circle ref={div5Ref} className="size-28 overflow-hidden p-2">
            <MarketIcons.otomoto />
          </Circle>
        </div>
      </div>
...
// Mark legacy `Icons` object as used (we currently render `MarketIcons`).
void Icons;
